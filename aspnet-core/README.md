...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9c949ee2-7016-4296-aa71-cd2310e6a0c7
```

> `9c949ee2-7016-4296-aa71-cd2310e6a0c7` is the password of the certificate, you can change it to any password you want.
